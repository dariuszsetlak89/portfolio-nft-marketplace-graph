...
export class ProceedsWithdrawalSuccess extends ethereum.Event {
  get params(): ProceedsWithdrawalSuccess__Params {
    return new ProceedsWithdrawalSuccess__Params(this);
  }
}

export class ProceedsWithdrawalSuccess__Params {
  _event: ProceedsWithdrawalSuccess;

  constructor(event: ProceedsWithdrawalSuccess) {
    this._event = event;
  }
...
export class TransferReceived extends ethereum.Event {
  get params(): TransferReceived__Params {
    return new TransferReceived__Params(this);
  }
}

export class TransferReceived__Params {
  _event: TransferReceived;

  constructor(event: TransferReceived) {
    this._event = event;
  }
